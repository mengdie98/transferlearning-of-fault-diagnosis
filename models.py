...
class TransferNet(nn.Module):
    def __init__(self, num_class, base_net='resnet18', transfer_loss='mmd', use_bottleneck=True, bottleneck_width=256, max_iter=1000, **kwargs):
...
def get_pretrain_model(args, weights_path):
    model = TransferNet(
